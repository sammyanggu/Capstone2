      ...
      >
        ...
        <nav className="pt-12">
          <ul className="flex flex-col gap-2 text-slate-200 text-base">
            ...
            <li><a href="#responsive" className="block py-2 px-3 rounded hover:bg-slate-800 hover:text-fuchsia-400 transition">Responsive Design</a></li>
            <li><a href="#components" className="block py-2 px-3 rounded hover:bg-slate-800 hover:text-fuchsia-400 transition">Components</a></li>
            <li><a href="#customization" className="block py-2 px-3 rounded hover:bg-slate-800 hover:text-fuchsia-400 transition">Customization</a></li>
            <li><a href="#layouts" className="block py-2 px-3 rounded hover:bg-slate-800 hover:text-fuchsia-400 transition">Common Layouts</a></li>
          </ul>
        </nav>
      </aside>
      <div className="w-full flex justify-center">
        <div className="max-w-4xl flex-1 pt-28 px-4 sm:px-8 md:ml-64">
          <header className="mb-10 border-b border-fuchsia-600 pb-6" id="home">
            <h1 className="text-4xl font-bold text-fuchsia-400 mb-2">Tailwind CSS</h1>
            <p className="text-lg text-fuchsia-200">Master utility-first CSS with Tailwind!</p>
          </header>

          <section id="intro" className="mb-10">
            <h2 className="text-2xl font-semibold text-fuchsia-300 mb-2">Getting Started with Tailwind</h2>
            <p className="text-slate-200 mb-4">Tailwind CSS is a highly customizable, utility-first CSS framework that helps you build modern websites without ever leaving your HTML. Unlike traditional frameworks, Tailwind is highly flexible and gives you complete control over your design.</p>

            <div className="bg-slate-700 p-4 rounded-lg mb-6">
              <h4 className="text-fuchsia-300 mb-2">Why Choose Tailwind CSS?</h4>
            ...
            <div className="bg-slate-700 p-4 rounded-lg mb-6">
              <h4 className="text-fuchsia-300 mb-2">Multiple Setup Options:</h4>
              <ul className="list-disc pl-6 text-slate-200 space-y-2">
...
<body>
  <div class="container mx-auto px-4 py-8">
    ...
    <p class="mt-4 text-gray-600">Welcome to utility-first CSS</p>
  </div>
</body>
</html>`} />
          </section>
          ...
          <section id="utility" className="mb-10">
            <h2 className="text-2xl font-semibold text-fuchsia-300 mb-2">Utility Classes</h2>
            <p className="text-slate-200 mb-4">Tailwind's power comes from its comprehensive set of utility classes that you can combine to create any design.</p>

            <div className="bg-slate-700 p-4 rounded-lg mb-6">
              <h4 className="text-fuchsia-300 mb-2">Core Utility Categories:</h4>
              <ul className="list-disc pl-6 text-slate-200 space-y-2">
            ...
            <h3 className="text-xl text-fuchsia-300 mt-6 mb-2">Common Utility Patterns</h3>
            <LiveHtmlEditor initialCode={`<!DOCTYPE html>
<html>
<head>
  <script src="https://cdn.tailwindcss.com"></script>
    ...
    <div class="mt-4 space-y-2">
      ...
      <div class="bg-red-500 text-white p-2 rounded">Red background</div>
          ...
          <section id="responsive" className="mb-10">
            <h2 className="text-2xl font-semibold text-fuchsia-300 mb-2">Responsive Design</h2>
            <p className="text-slate-200 mb-4">Tailwind makes it easy to build responsive designs with responsive prefixes.</p>
            <LiveHtmlEditor initialCode={`<!DOCTYPE html>
<html>
<head>
  <script src="https://cdn.tailwindcss.com"></script>
      ...
      <div class="md:flex">
        <div class="p-8">
          ...
          <section id="components" className="mb-10">
            <h2 className="text-2xl font-semibold text-fuchsia-300 mb-2">Building Components</h2>
            <p className="text-slate-200 mb-4">Create reusable components by combining Tailwind utilities.</p>
            <LiveHtmlEditor initialCode={`<!DOCTYPE html>
<html>
<head>
  <script src="https://cdn.tailwindcss.com"></script>
    ...
    <button class="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
      Click me
          ...
          <section id="layouts" className="mb-10">
            <h2 className="text-2xl font-semibold text-fuchsia-300 mb-2">Common Layouts</h2>
            <p className="text-slate-200 mb-4">Create common layout patterns with Tailwind utilities.</p>
            <LiveHtmlEditor initialCode={`<!DOCTYPE html>
<html>
<head>
  <script src="https://cdn.tailwindcss.com"></script>
