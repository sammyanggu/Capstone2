        ...
        <div className="tutorials-container mt-20 sm:mt-16">
            ...
            <div className="tutorials-grid">
                ...
                <div className="tutorial-card">
                    ...
                    <h3 className="tutorial-card-title">HTML</h3>
                ...
                <div className="tutorial-card">
                    ...
                    <h3 className="tutorial-card-title">CSS</h3>
                ...
                <div className="tutorial-card">
                    ...
                    <h3 className="tutorial-card-title">JavaScript</h3>
                ...
                <div className="tutorial-card">
                    ...
                    <h3 className="tutorial-card-title">PHP</h3>
                ...
                <div className="tutorial-card">
                    ...
                    <h3 className="tutorial-card-title">Bootstrap</h3>
